...
import pl.michalmaslak.samplemobileapp.fragments.main.account.AccountNavHostFragment
import pl.michalmaslak.samplemobileapp.fragments.main.create_work_order.CreateWorkOrderNavHostFragment
import pl.michalmaslak.samplemobileapp.fragments.main.work_order.WorkOrderNavHostFragment
...
const val BOTTOM_NAV_BACK_STACK_KEY = "pl.michalmaslak.samplemobileapp.util.BottomNavController"
    ...
    private fun createNavHost(menuItemId: Int): Fragment {
        return when (menuItemId) {
            ...
            R.id.menu_nav_work_order -> {
                WorkOrderNavHostFragment.create(R.navigation.nav_workorder)
            }
            R.id.menu_nav_create_work_order -> {
                CreateWorkOrderNavHostFragment.create(R.navigation.nav_create_workorder)
            }
            else -> {
                WorkOrderNavHostFragment.create(R.navigation.nav_workorder)
            }

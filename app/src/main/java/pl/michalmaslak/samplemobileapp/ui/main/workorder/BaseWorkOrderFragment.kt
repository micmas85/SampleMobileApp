...
abstract class BaseWorkOrderFragment
constructor(
    @LayoutRes
...
): Fragment(layoutRes)
{
    ...
    val viewModel: WorkOrderViewModel by viewModels{
        viewModelFactory
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupActionBarWithNavController(R.id.workorderFragment, activity as AppCompatActivity)
        setupChannel()
    }
